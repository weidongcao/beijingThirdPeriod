...
public class ShopImportSolrBase {
    ...
    private static String[] columns = FieldConstants.COLUMN_MAP.get("oracle_reg_content_shop");
    private static String TABLE_NAME = "H_REG_CONTENT_SHOP_TMP";
    private static final String CF = "CONTENT_SHOP";
    private static final DateFormat timeFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private static final String taskType = "shop";
