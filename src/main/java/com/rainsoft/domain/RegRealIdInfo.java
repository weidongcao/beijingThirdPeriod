...
public class RegRealIdInfo {
    ...
    public String getQq_nums() {
        return qq_nums;
    }

    public void setQq_nums(String qq_nums) {
        this.qq_nums = qq_nums;
    }
    ...
    public String getId_expiretime() {
        return id_expiretime;
    }

    public void setId_expiretime(String id_expiretime) {
        this.id_expiretime = id_expiretime;
    }
